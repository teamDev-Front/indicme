...
export default function LeadConversionModal({ 
  ...
  }, [arcadasSelecionadas, commissionSettings])
    ...
    try {
      ...
      const { error: commissionError } = await supabase
        ...
        .insert({
          ...
          amount: commission.valorTotal,
          arcadas_vendidas: arcadasSelecionadas,
          valor_por_arcada: commissionSettings.valor_por_arcada,
          bonus_conquistados: commission.novosBonus,
          valor_bonus: commission.valorBonus,
          type: 'consultant',
          status: 'pending'
        })
      ...
      // 3. Se o consultor tem um manager, criar comissão para o manager também
      ...
      if (hierarchy?.manager_id) {
        ...
        const managerAmount = commission.valorTotal * 0.1
        ...
        await supabase
          ...
          .insert({
            ...
            arcadas_vendidas: arcadasSelecionadas,
            valor_por_arcada: commissionSettings.valor_por_arcada * 0.1,
      ...
      if (commission.ganhaBonus) {
        toast.success(`🎉 Consultor ganhou ${commission.novosBonus} bônus de R$ ${commissionSettings.valor_bonus}!`, {
          duration: 6000
        })
      }
